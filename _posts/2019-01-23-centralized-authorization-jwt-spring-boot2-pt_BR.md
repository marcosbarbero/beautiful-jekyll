---
layout: post
title: Auth Server Centralizado com JWT usando Spring Boot 2
...
# Footnote
 - O código desse tutorial pode ser encontrado no [GitHub](https://github.com/marcosbarbero/spring-boot-n-cloud-playground/tree/master/security).
 ...
 - [Spring Boot 2 - Guia de migração](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-2.0-Migration-Guide#authenticationmanager-bean)
